...
Esta práctica consiste en crear un componente de Gatsby que recibe el nombre de un evento y la fecha en la que se va a realizar. Para ello se ha utilizado el siguiente código:

```javascript
function Event({eventName, date, image}) {
  return (
...
Además se ha trabajado sobre el projecto de iniciación a Gatsby y Tailwind **[gatsby-tailwindcss-starter](https://www.gatsbyjs.com/starters/kosvrouvas/gatsby-tailwindcss-starter)**.
