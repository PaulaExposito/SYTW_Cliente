...
const IndexPage = () => (
  <Layout>
    <SEO title="Home" />
    <h1 class="text-6xl mb-4">¡Feliz Navidad!</h1>
    <p class="text-xl mb-8">Bienvenidos a la práctica de Accesibilidad de Gatsby</p>
    ...
    <Link class="text-xl" to="/events">Ver los eventos programados</Link><br/>
  </Layout>
)
